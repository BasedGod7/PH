...
var commands = exports.commands = {
	...
	join: function (target, room, user, connection) {
		...
		if (target === 'lobby') {
			connection.sendTo('lobby','|html|<center><img src="http://i.imgur.com/yZ6G3fS.png" /></center><div class="welcome"><center><div id="welcome-content"><center><b><font size=2>Bienvenido a Pokemon Hispano</font></b><br /><br /><em>Participa en nuestros eventos oficiales, torneos, ligas y mucho mas ganando premios</em></center><br /><hr /><br /><center>Usa los botones de abajo, para navegar en las distintas opciones.</center><br /><center><a href="http://www.pokemon-hispano.comxa.com"><button>Foro</button></a><button name="send" value="/reglas">Reglas</button><button name="send" value="/lideres">Lideres</button><a href="https://www.facebook.com/groups/PokemonHispanoShowdown/"><button>Facebook</button></a><a href="http://www.twitch.tv/pokemonhispano/"><button>Livestream</button></a></center><br /><center>Si tienes alguna duda o sugerencia visita nuestro foro.<br /><br /><em>Para asuntos de moderación contactar con rangos mayores del staff & (Leaders) o ~ (Administradores)</em></center></div></center></div><center><img src="http://i.imgur.com/qFllIAe.png" /></center></div><center><img src="http://i.imgur.com/qFllIAe.png" /></center>');
		}
	},
