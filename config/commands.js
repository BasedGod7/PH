...
var commands = exports.commands = {
	...
	liga: function (target, room, user) {
		...
		buffer += 'Based Hispano<br><br>';
		buffer += '<a href=' + path + 252 + '><button>ALTO MANDO</button></a><br>';
		buffer += '(LoD)Tyrana: Dragon<br>';
		buffer += 'Shiny Giratina-O: Agua<br>';
		buffer += 'Disponible: Sunny<br>';
		buffer += 'CH Leo Calderon: Psiquico<br>';
		buffer += '(LoD)Marcos: Acero<br><br>';
		buffer += '<b><font color="red">LÍDERES DE GIMNASIOS</font></b><br>';
		buffer += '<a href=' + path + 000 + '><button>M4R4UD3R: Normal</button></a>   ';
		buffer += '<a href=' + path + 000 + '><button>(CH) TheFlygon: Hielo</button></a>   ';
		...
		buffer += '<a href=' + path + 000 + '><button>(CC) Ranger Arthur: Roca</button></a>   ';
		buffer += '<a href=' + path + 000 + '><button>Andy E: Hada</button></a>   ';
		buffer += '<a href=' + path + 000 + '><button>(CC) lyndis: Volador</button></a>   ';
		buffer += '<a href=' + path + 504 + '><button>(MoD) Airwind: Fantasma</button></a>   ';
		buffer += '<a href=' + path + 000 + '><button>ŠN? ?SweetPosho: Tierra</button></a>   ';
		buffer += '<a href=' + path + 000 + '><button>(CC)Mr.Poke: Siniestro</button></a>   ';
		buffer += '<a href=' + path + 000 + '><button>waterMISTY♡: Veneno</button></a>   ';
