...
var commands = exports.commands = {
	...
	liga: function (target, room, user) {
		...
		buffer += '<a href=' + path + 000 + '><button>FC CAMULOS: Normal</button></a>   ';
		buffer += '<a href=' + path + 000 + '><button>Disponible: Hielo</button></a>   ';
		buffer += '<a href=' + path + 000 + '><button>ADRIELANDRO: Agua</button></a>   ';
		buffer += '<a href=' + path + 514 + '><button>Spirit Virgo: Lucha</button></a>   ';
		buffer += '<a href=' + path + 000 + '><button>cusho: Bicho</button></a>   ';
		buffer += '<a href=' + path + 000 + '><button>(CC) FC Striker: Roca</button></a>   ';
		buffer += '<a href=' + path + 575 + '><button>Gardevoir>w<: Hada</button></a>   ';
		buffer += '<a href=' + path + 570 + '><button>P✘S Lightning: Volador</button></a>   ';
		buffer += '<a href=' + path + 569 + '><button>ZeZStarZeZ: Fantasma</button></a>   ';
		...
		buffer += '<a href=' + path + 000 + '><button>Disponible: Fuego</button></a>   ';
		buffer += '<a href=' + path + 000 + '><button>Disponible: Dragón</button></a>   ';
