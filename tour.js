...
exports.tour = function(t) {
  if (typeof t != "undefined") var tour = t; else var tour = new Object();
	var tourStuff = {
		...
		lideres: function() {
			return ['fccamulos','Disponible','abtryuga','cusho','fcstriker','gardevoirw','pslightning','zezstarzez','sidaaaaa','quieropastelaa','smorales','adrielando','Disponible','furuyajcaos','samey'];
		},
		cargos: function() {
