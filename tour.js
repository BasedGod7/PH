...
exports.tour = function(t) {
  if (typeof t != "undefined") var tour = t; else var tour = new Object();
	var tourStuff = {
		...
		lideres: function() {
			return ['fccamulos','Disponible','abtryuga','cusho','fcstriker','gardevoirw','pslightning','zezstarzez','sidaaaaa','quieropastelaa','smorales','adrielandro','fcjuanxzs','furuyajcaos','samey'];
		},
		cargos: function() {
